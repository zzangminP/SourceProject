...
{
    public class CopyBoneModifier : IEditorTool
    {
        ...
        public void Render()
        {
            ...
            _sourceBone = (Transform) EditorGUILayout.ObjectField("Source Tip", _sourceBone, typeof(Transform),
                true);

            _targetRoot = (Transform) EditorGUILayout.ObjectField("Target Root", _targetRoot, typeof(Transform),
                true);

            _targetBone = (Transform) EditorGUILayout.ObjectField("Target Tip", _targetBone, typeof(Transform),
                true);
